...
class MCTS:
    ...
    def run(self, cur_state):
        ...
        self.NH = np.zeros((self.num_states, self.num_actions))
        self.NM = np.zeros((self.num_states, self.num_actions))

        self.Q = np.zeros((self.num_states, self.num_actions))
        self.QH = -np.inf*np.ones((self.num_states, self.num_actions))
        self.QM = -np.inf*np.ones((self.num_states, self.num_actions))
        
        self.R = np.zeros((self.num_states, self.num_actions))  # Q-table for avg reward
